...
import { faListAlt, faBookDead, faBomb } from '@fortawesome/free-solid-svg-icons'
      ...
      <Col md="4" sm="6" xs="12">
        <div className="feature-block hover-effect-one">
          <div className="image">
            <img src={image} alt />
            <div className="title">
              <h5><a href="course-details.html">Deep Learning</a></h5>
              <div className="number">01</div>
            </div>
          </div> {/* /.image */}
          <div className="wrapper">
            <div className="icon"><FontAwesomeIcon icon={faListAlt} /></div>
            <h5><a href="course-details.html">Deep Learning</a></h5>
      ...
      <Col md="4" sm="6" xs="12">
        <div className="feature-block hover-effect-one">
          <div className="image">
            <img src={image} alt />
            <div className="title">
              <h5><a href="course-details.html">Learning Courses</a></h5>
              <div className="number">02</div>
            </div>
          </div> {/* /.image */}
          <div className="wrapper">
            <div className="icon"><FontAwesomeIcon icon={faBookDead} /></div>
            <h5><a href="course-details.html">Learning Courses</a></h5>
      ...
      <Col md="4" sm="6" xs="12">
        <div className="feature-block hover-effect-one">
          <div className="image">
            <img src={image} alt />
            <div className="title">
              <h5><a href="course-details.html">Study Coaching</a></h5>
              <div className="number">03</div>
            </div>
          </div> {/* /.image */}
          <div className="wrapper">
            <div className="icon"><FontAwesomeIcon icon={faBomb} /></div>
            <h5><a href="course-details.html">Study Coaching</a></h5>
